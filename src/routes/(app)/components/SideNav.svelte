...
<div
  role="navigation"
  class="fixed right-5 bottom-5 left-5 z-40 flex justify-center gap-2 rounded-full border border-zinc-200 bg-zinc-50 p-2 shadow lg:sticky lg:top-0 lg:right-0 lg:bottom-0 lg:left-0 lg:h-screen lg:w-auto lg:flex-col lg:justify-start lg:rounded-none lg:border-y-0 lg:border-r lg:border-l-0 lg:shadow-none lg:backdrop-blur-none dark:border-zinc-800 dark:backdrop-blur-md"
>
