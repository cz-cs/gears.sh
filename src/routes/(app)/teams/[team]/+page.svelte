        ...
        {:then rankings}
          <div class="grid auto-cols-max grid-cols-1 gap-2 md:grid-cols-2">
            {#each rankings.data as rank}
              <a
                class="inline-flex flex-col justify-center space-y-2 rounded-md border border-zinc-200 bg-zinc-50 p-3 text-sm font-medium shadow-md hover:bg-zinc-100 dark:border-zinc-800 dark:bg-zinc-950 dark:hover:bg-zinc-900"
