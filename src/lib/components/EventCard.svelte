...
<a
  class="flex flex-col gap-1 rounded-lg border border-zinc-200 p-3 text-sm shadow transition-colors duration-300 hover:bg-zinc-100 dark:border-zinc-800 dark:hover:bg-zinc-900"
